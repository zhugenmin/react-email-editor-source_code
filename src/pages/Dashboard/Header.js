const Header = (props) => {
  ...
  return (
    <div className="h-16 w-full bg-slate-600 flex justify-between items-center border-none px-6">
      <div className="text-white text-3xl font-bold font-sans">Email Editor</div>
